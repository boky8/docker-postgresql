[![Circle CI](https://circleci.com/gh/boky/docker-postgresql.svg?style=shield)](https://circleci.com/gh/boky/docker-postgresql) [![Docker Repository on Quay.io](https://quay.io/repository/boky/postgresql/status "Docker Repository on Quay.io")](https://quay.io/repository/boky/postgresql) [![](https://badge.imagelayers.io/boky/postgresql.svg)](https://imagelayers.io/?images=boky/postgresql:latest 'Get your own badge on imagelayers.io')

# boky/postgresql:9.6.0-01
...
```bash
docker pull boky/postgresql:9.6.0-01
```

Alternatively you can build the image yourself.

```bash
docker build -t boky/postgresql github.com/boky/docker-postgresql
```
...
```bash
docker run --name postgresql -itd --restart always \
  boky/postgresql:9.6.0-01 -c log_connections=on
```
...
```bash
docker run --name postgresql -itd --restart always \
  boky/postgresql:9.6.0-01 -c logging_collector=on
```

To access the PostgreSQL logs you can use `docker exec`. For example:

```bash
docker exec -it postgresql tail -f /var/log/postgresql/postgresql-9.6.0-main.log
```
